...
class AppSettingsModel(BaseModel):
    ...
    # Patch 2: VRAM safety margin
    vram_safety_margin_percent: int = Field(default=15, ge=5, le=50, description="Percent of VRAM to reserve for KV cache overhead")

    # Patch 3: Reasoning detection
